...
namespace MFCFriendlyDriverGenerator {
    ...
    public class MFCFriendlyDriverTable {
        ...
        readonly IReadOnlyDictionary<ControlKind, string> ControlKindToDriverType = new Dictionary<ControlKind, string>() {
            ...
            {ControlKind.CTEXT,           "Codeer.Friendly.Windows.NativeStandardControls.WindowControl"},
            ...
            {ControlKind.LTEXT,           "Codeer.Friendly.Windows.NativeStandardControls.WindowControl"},
            ...
            {ControlKind.RTEXT,           "Codeer.Friendly.Windows.NativeStandardControls.WindowControl"},
